...
class DirectoryIterator(Iterator):
    ...
    def next(self):
        ...
        # batch_x = np.zeros((current_batch_size,)  +(self.image_shape[0],) +(self.frames_per_step,)+       
        #                    (self.image_shape[1],) + (self.image_shape[2],), dtype=K.floatx())   # # my addition of +(1,)
        ...
        if self.class_mode == 'input':
            ...
            return batch_x
        # print("FINAL: ", np.array(batch_x).shape)
        return batch_x, batch_y
